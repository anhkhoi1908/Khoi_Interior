    ...
    return (
        <Fragment>
            <div id="news" className="mt-[10rem] text-[#292F36]">
                <h1 className="font-dm-serif font-bold text-4xl text-center mb-4">{"Articles & News"}</h1>
                <p className="font-jost tracking-wider w-2/5 mx-auto text-center">{'It is a long established fact that a reader will be distracted by the of readable content of a page when lookings at its layouts the points of using.'}</p>
                        ...
                        {news.map((el, index) => (
                            <li key={index} className="mb-10 w-[32%]">
                                <Link className="block p-[1rem] link hover:bg-[#E7E7E7] rounded-[2.5rem] border-2 duration-300" to={'/blog'}>
                                    ...
                                    <h2 className="font-dm-serif font-bold text-[1.6rem] mt-4">{el.content}</h2>
