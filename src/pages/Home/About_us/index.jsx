...
import { faRightLong, faPhone, faArrowRight } from "@fortawesome/free-solid-svg-icons";
            ...
            <div className="about_us w-3/5 mx-auto text-[#292F36]">
                <div id="about_us" className="flex justify-between w-full mx-auto">
                    <div className="w-2/5 about_us_info">
                        <h1 className="font-bold text-5xl mb-8 font-dm-serif">
                            {"We Create The Art Of Stylish Living Stylishly"}
                        </h1>
                        <p className="font-jost tracking-wider text-justify">{"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam."}</p>
                        <div className="flex items-center mt-8">
                            ...
                            <div className="ml-6">
                                ...
                                <p className="font-jost">{"Call Us Anytime"}</p>
                            </div>
                        </div>     
                        <button className="bg-[#292F36] p-4 rounded-xl mt-8 hover:opacity-75 duration-300">
                            <Link className="link" to={'/projects'}>
                                <span className="text-white mr-4 font-jost">{"Get Free Estimate"}</span>
