        ...
        <Fragment>
            <div id="banner">
                ...
                <div className="inline-block w-1/3 absolute top-1/3 left-[20%]">
                    ...
                    <p className="my-8">{"There are many variations of the passages of lorem Ipsum fromavailable,variations of the passages."}</p>
                    <button className="bg-[#292F36] rounded-3xl">
