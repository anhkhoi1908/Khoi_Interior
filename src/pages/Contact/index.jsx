        ...
        <Fragment>
            ...
            <div id="block" className="w-3/5 mx-auto mt-[10rem] relative">
                ...
                <div id="contact" className="flex mt-20">
                    ...
                    <ul className="contact_inputs flex flex-wrap justify-between">
                        ...
                        <div className="text-area border-b-2 border-black w-full">
                ...
                <div id="btn-send" className="text-end">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.939175113799!2d106.68880027514517!3d10.739171389407343!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752eec7745a3db%3A0xd67efac4e9d528c5!2zVHLGsOG7nW5nIENhbyDEkeG6s25nIFZp4buHdCBN4bu5!5e0!3m2!1svi!2s!4v1696824915749!5m2!1svi!2s"
                ...
                className="mx-auto rounded-3xl mt-[10rem] w-3/5 h-[25rem]"
            ></iframe>
        </Fragment>
    );
};
